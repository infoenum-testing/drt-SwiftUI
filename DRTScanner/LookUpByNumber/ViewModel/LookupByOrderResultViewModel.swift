...
class LookupByOrderResultViewModel: ObservableObject {
    ...
    func fetchSeats(c: String, q: String) async {
        ...
        do {
            ...
            DispatchQueue.main.async {
                self.buyerName = fetchedOrder.first?.buyerName?.uppercased()
            }
        ...
        do {
            ...
            DispatchQueue.main.async {
                if let firstOrder = fetchedOrders.first {
                    ...
                    self.buyerName = firstOrder.buyerName?.uppercased()
                    ...
                    self.buyerName = StringManager.shared.strings?.searchResults.resultNotFound ?? StringConstants.Common.noOrdersFound
